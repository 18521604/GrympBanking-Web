  ...
  return (
    <form className="signup-form">
      ...
      <div className="signup-form__row signup-form__text-field">
        ...
        <input className="signup-form__input" id="signup-1" placeholder="VD: 231245297" type="number" />
      ...
      <div className="signup-form__row signup-form__text-field">
        ...
        <input className="signup-form__input" id="signup-2" placeholder="VD: 15/06/2015" type="date" data-date-format="DD MMMM YYYY"/>
        <object className="signup-form__validate-icon" aria-label="check-icon" data={DoneIcon} />
      </div>
      <div className="signup-form__row signup-form__text-field">
