...
export function HeaderBar(){
    return(
        <div className="w-full flex flex-col items-center">
            <span className="md:text-2xl text-base text-secondtext-color mt-4"><b className='text-white'>GRYMP</b> Banking</span>
            <div className="flex flex-col border border-white w-4/5 items-center py-4 mt-10 space-y-2">
